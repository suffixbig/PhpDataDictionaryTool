...
--
-- 資料庫： `cart_opencart_00`
--
CREATE DATABASE IF NOT EXISTS `cart_opencart_00` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `cart_opencart_00`;
...
CREATE TABLE `oc_address` (
  `address_id` int(11) NOT NULL COMMENT '地址主鍵（自動增長）',
  `customer_id` int(11) NOT NULL COMMENT '會員的註冊ID(與customer表的主鍵關聯)',
  `firstname` varchar(32) NOT NULL COMMENT '姓',
  `lastname` varchar(32) NOT NULL COMMENT '名',
  `company` varchar(40) NOT NULL COMMENT '公司',
  `address_1` varchar(128) NOT NULL COMMENT '街道地址1',
  `address_2` varchar(128) NOT NULL COMMENT '街道地址2可隨意填寫',
  `city` varchar(128) NOT NULL COMMENT '城市',
  `postcode` varchar(10) NOT NULL COMMENT '郵編',
  `country_id` int(11) NOT NULL DEFAULT '0' COMMENT '國家編號(iso)（關聯counry表的主鍵 country_id）',
  `zone_id` int(11) NOT NULL DEFAULT '0' COMMENT '地區編號(iso)關聯zone表的主鍵zone_id',
  `custom_field` text NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT '地址表:用於存放會員的地址信息\r\n#主鍵：address_id\r\n#註解2\r\n';
...
CREATE TABLE `oc_affiliate` (
  `affiliate_id` int(11) NOT NULL COMMENT '',
  ...
  `fax` varchar(32) NOT NULL COMMENT '',
  `password` varchar(40) NOT NULL COMMENT '',
  `salt` varchar(9) NOT NULL COMMENT '',
  `company` varchar(40) NOT NULL COMMENT '',
  `website` varchar(255) NOT NULL COMMENT '',
  `address_1` varchar(128) NOT NULL COMMENT '',
  `address_2` varchar(128) NOT NULL COMMENT '',
  `city` varchar(128) NOT NULL COMMENT '',
  `postcode` varchar(10) NOT NULL COMMENT '',
  `country_id` int(11) NOT NULL COMMENT '',
  `zone_id` int(11) NOT NULL COMMENT '',
  `code` varchar(64) NOT NULL COMMENT '',
  `commission` decimal(4,2) NOT NULL DEFAULT '0.00',
  `tax` varchar(64) NOT NULL COMMENT '',
  `payment` varchar(6) NOT NULL COMMENT '',
  `cheque` varchar(100) NOT NULL COMMENT '',
  `paypal` varchar(64) NOT NULL COMMENT '',
  `bank_name` varchar(64) NOT NULL COMMENT '',
  `bank_branch_number` varchar(64) NOT NULL COMMENT '',
  `bank_swift_code` varchar(64) NOT NULL COMMENT '',
  `bank_account_name` varchar(64) NOT NULL COMMENT '',
  `bank_account_number` varchar(64) NOT NULL COMMENT '',
...
CREATE TABLE `oc_affiliate_activity` (
  `affiliate_activity_id` int(11) NOT NULL COMMENT '',
  `affiliate_id` int(11) NOT NULL COMMENT '',
...
CREATE TABLE `oc_affiliate_login` (
  `affiliate_login_id` int(11) NOT NULL COMMENT '',
  `email` varchar(96) NOT NULL COMMENT '',
  `ip` varchar(40) NOT NULL COMMENT '',
  `total` int(4) NOT NULL COMMENT '',
  `date_added` datetime NOT NULL COMMENT '',
...
CREATE TABLE `oc_affiliate_transaction` (
  `affiliate_transaction_id` int(11) NOT NULL COMMENT '',
  `affiliate_id` int(11) NOT NULL COMMENT '',
...
(1, 'Default', '', 1, '2017-04-21 16:38:02', '2017-04-21 16:38:02');
...
CREATE TABLE `oc_api_ip` (
  `api_ip_id` int(11) NOT NULL COMMENT '',
  `api_id` int(11) NOT NULL COMMENT '',
  `ip` varchar(40) NOT NULL COMMENT '' 
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT '' ;
...
CREATE TABLE `oc_api_session` (
  `api_session_id` int(11) NOT NULL COMMENT '',
  `api_id` int(11) NOT NULL COMMENT '',
  `token` varchar(32) NOT NULL COMMENT '',
  `session_id` varchar(32) NOT NULL COMMENT '',
  `session_name` varchar(32) NOT NULL COMMENT '',
  `ip` varchar(40) NOT NULL COMMENT '',
  `date_added` datetime NOT NULL COMMENT '',
  `date_modified` datetime NOT NULL COMMENT '' 
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT '' ;
...
CREATE TABLE `oc_banner` (
  `banner_id` int(11) NOT NULL COMMENT '',
  `name` varchar(64) NOT NULL COMMENT '',
  `status` tinyint(1) NOT NULL COMMENT '' 
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT '' ;
...
CREATE TABLE `oc_banner_image` (
  `banner_image_id` int(11) NOT NULL COMMENT '',
  `banner_id` int(11) NOT NULL COMMENT '',
  `language_id` int(11) NOT NULL COMMENT '',
...
CREATE TABLE `oc_cart` (
  `cart_id` int(11) UNSIGNED NOT NULL COMMENT '主健',
  `api_id` int(11) NOT NULL COMMENT '',
  `customer_id` int(11) NOT NULL COMMENT '會員id',
  `session_id` varchar(32) NOT NULL COMMENT 'session_id',
  `product_id` int(11) NOT NULL COMMENT '商品編號',
  `recurring_id` int(11) NOT NULL COMMENT '0',
  `option` text NOT NULL COMMENT '這是{"226":"16"}這種格式',
  `quantity` int(5) NOT NULL COMMENT '數量',
  `date_added` datetime NOT NULL COMMENT '加入購物車時間' 
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT '購物車暫存表:用於儲存購物車內容' ;
...
CREATE TABLE `oc_category` (
  `category_id` int(11) NOT NULL COMMENT '分類主鍵',
  `image` varchar(255) DEFAULT NULL COMMENT '圖片名稱',
  `parent_id` int(11) NOT NULL DEFAULT '0' COMMENT '父節點ID',
  `top` tinyint(1) NOT NULL COMMENT '',
  `column` int(3) NOT NULL COMMENT '',
  `sort_order` int(3) NOT NULL DEFAULT '0' COMMENT '排序ID',
  `status` tinyint(1) NOT NULL COMMENT '狀態（顯示/不顯示）即該分類可用/不可用',
  `date_added` datetime NOT NULL COMMENT '添加日期',
  `date_modified` datetime NOT NULL COMMENT '修改日期' 
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT '產品分類表：用於商品的多級分類#主鍵：category_id' ;
...
CREATE TABLE `oc_category_description` (
  `category_id` int(11) NOT NULL COMMENT '分類主鍵',
  `language_id` int(11) NOT NULL COMMENT '語言主鍵',
  `name` varchar(255) NOT NULL COMMENT '分類名稱',
  `description` text NOT NULL COMMENT '分類的描述信息',
  `meta_title` varchar(255) NOT NULL COMMENT 'Meta標題',
  `meta_description` varchar(255) NOT NULL COMMENT 'Meta標籤描述',
  `meta_keyword` varchar(255) NOT NULL COMMENT 'Meta標籤關鍵字' 
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT '產品分類信息描述表：用於商品的多級分類#主鍵：category_id,language_id' ;
...
CREATE TABLE `oc_category_filter` (
  ...
  `filter_id` int(11) NOT NULL COMMENT '' 
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT '' ;
...
CREATE TABLE `oc_category_path` (
  `category_id` int(11) NOT NULL COMMENT '',
  `path_id` int(11) NOT NULL COMMENT '',
...
CREATE TABLE `oc_category_to_store` (
  `category_id` int(11) NOT NULL COMMENT '分類主鍵',
  `store_id` int(11) NOT NULL COMMENT '商店編號' 
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT '產品分類和商店關聯表' ;
...
CREATE TABLE `oc_country` (
  `country_id` int(11) NOT NULL COMMENT '國家編號（主鍵）',
  `name` varchar(128) NOT NULL COMMENT '國家名稱',
  `iso_code_2` varchar(2) NOT NULL COMMENT '',
  `iso_code_3` varchar(3) NOT NULL COMMENT '支付所需要的國家代碼',
  `address_format` text NOT NULL COMMENT '未明白',
  `postcode_required` tinyint(1) NOT NULL COMMENT '',
  `status` tinyint(1) NOT NULL DEFAULT '1' COMMENT '狀態（可用/不可用）'
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT '存儲國家ISO代碼，以及支付通道需要的國家代碼#主鍵:country_id' ;
...
CREATE TABLE `oc_coupon` (
  `coupon_id` int(11) NOT NULL COMMENT '優惠券主鍵（自增）',
  `name` varchar(128) NOT NULL COMMENT '',
  `code` varchar(20) NOT NULL COMMENT '優惠券代碼（買家需要填該代碼才能享受到優惠）',
  `type` char(1) NOT NULL COMMENT '優惠券的類型(1.百分率折扣；2.固定金額的打折)',
  `discount` decimal(15,4) NOT NULL COMMENT '打折率',
  `logged` tinyint(1) NOT NULL COMMENT '登陸狀態（設置優惠券是否登陸可用）',
  `shipping` tinyint(1) NOT NULL COMMENT '運費狀態（是否免運費）',
  `total` decimal(15,4) NOT NULL COMMENT '暫不明確',
  `date_start` date NOT NULL DEFAULT '0000-00-00' COMMENT '優惠券生效日期',
  `date_end` date NOT NULL DEFAULT '0000-00-00' COMMENT '優惠券失效日期',
  `uses_total` int(11) NOT NULL COMMENT '該優惠券可用次數（所有會員）',
  `uses_customer` varchar(11) NOT NULL COMMENT '每位註冊會員對該優惠券可用次數',
  `status` tinyint(1) NOT NULL COMMENT '優惠券狀態',
  `date_added` datetime NOT NULL COMMENT '優惠券添加日期' 
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT '優惠券信息表:存儲優惠券的相關信息設置。' ;
...
CREATE TABLE `oc_coupon_history` (
  `coupon_history_id` int(11) NOT NULL COMMENT '',
  `coupon_id` int(11) NOT NULL COMMENT '',
  `order_id` int(11) NOT NULL COMMENT '',
...
CREATE TABLE `oc_coupon_product` (
  `coupon_product_id` int(11) NOT NULL COMMENT '主鍵(自增)',
  `coupon_id` int(11) NOT NULL COMMENT '優惠券編號（關聯coupon表主鍵）',
  `product_id` int(11) NOT NULL COMMENT '商品編號（關聯product表主鍵）' 
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT '優惠券與商品關聯表:存儲優惠券編號(coupon_id)和商品編號(product_id)#主鍵: coupon_product_id' ;
...
CREATE TABLE `oc_currency` (
  `currency_id` int(11) NOT NULL COMMENT '主鍵(自增)',
  `title` varchar(32) NOT NULL COMMENT '商店頁面需要顯示的貨幣名稱（eg: US Dollar、Euro）',
  `code` varchar(3) NOT NULL COMMENT '貨幣代碼(eg：USD、EUR)',
  `symbol_left` varchar(12) NOT NULL COMMENT '貨幣符號金額左邊顯示（eg:$32、￥45、）',
  `symbol_right` varchar(12) NOT NULL COMMENT '貨幣符號金額右邊顯示',
  `decimal_place` char(1) NOT NULL COMMENT '保留小數點後幾位有效數字',
  `value` float(15,8) NOT NULL COMMENT '該貨幣對應商店默認貨幣的匯率',
  `status` tinyint(1) NOT NULL COMMENT '貨幣狀態',
  `date_modified` datetime NOT NULL COMMENT '修改時間' 
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT '貨幣表:存儲商店支持的貨幣信息。#主鍵: currency_id' ;
...
(1, '新台幣', 'TWD', 'NT', '', '0', 1.00000000, 1, '2017-04-21 16:38:45'),
(2, '人民幣', 'CNY', '¥', '', '2', 0.22600000, 1, '2017-04-21 16:38:45'),
(3, '港幣', 'HKD', 'HK', '', '2', 0.25529999, 1, '2017-04-21 16:38:45'),
(4, '英鎊', 'GBP', '£', '', '2', 0.02570000, 1, '2017-04-21 16:38:45'),
(5, '美元', 'USD', '$', '', '2', 0.03290000, 1, '2017-04-21 16:38:45'),
(6, '歐元', 'EUR', '', '€', '2', 0.03070000, 1, '2017-04-21 16:38:45');
...
CREATE TABLE `oc_customer` (
  `customer_id` int(11) NOT NULL COMMENT '主鍵(自增)',
  `customer_group_id` int(11) NOT NULL COMMENT '',
  `store_id` int(11) NOT NULL DEFAULT '0' COMMENT '商店編號（關聯store表主鍵）',
  `language_id` int(11) NOT NULL COMMENT '語言id',
  `firstname` varchar(32) NOT NULL COMMENT '姓',
  `lastname` varchar(32) NOT NULL COMMENT '名',
  `email` varchar(96) NOT NULL COMMENT '電子信箱',
  `telephone` varchar(32) NOT NULL COMMENT '電話號碼',
  `fax` varchar(32) NOT NULL COMMENT '傳真',
  `password` varchar(40) NOT NULL COMMENT '密碼',
  `salt` varchar(9) NOT NULL COMMENT '',
  `cart` text COMMENT '擴展字段（暫時未用）',
  `wishlist` text COMMENT '',
  `newsletter` tinyint(1) NOT NULL DEFAULT '0' COMMENT '擴展字段（暫時未用）',
  `address_id` int(11) NOT NULL DEFAULT '0' COMMENT '地址編號(關聯address表主鍵)',
  `custom_field` text NOT NULL COMMENT '',
  `ip` varchar(40) NOT NULL COMMENT '會員註冊時的IP地址',
  `status` tinyint(1) NOT NULL COMMENT '狀態',
  `approved` tinyint(1) NOT NULL COMMENT '擴展字段（暫時未用）',
  `safe` tinyint(1) NOT NULL COMMENT '狀態',
  `token` text NOT NULL COMMENT '',
  `code` varchar(40) NOT NULL COMMENT '',
  `date_added` datetime NOT NULL COMMENT '會員註冊日期' 
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT '註冊會員信息表' ;
...
CREATE TABLE `oc_customer_activity` (
  `customer_activity_id` int(11) NOT NULL COMMENT '',
  `customer_id` int(11) NOT NULL COMMENT '',
  `key` varchar(64) NOT NULL COMMENT '',
  `data` text NOT NULL COMMENT '',
  `ip` varchar(40) NOT NULL COMMENT '',
...
CREATE TABLE `oc_customer_group` (
  `customer_group_id` int(11) NOT NULL COMMENT '主鍵(自增)',
  `approval` int(1) NOT NULL COMMENT '',
  `sort_order` int(3) NOT NULL COMMENT '' 
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT '會員組別表' ;
...
CREATE TABLE `oc_customer_history` (
  `customer_history_id` int(11) NOT NULL COMMENT '',
  `customer_id` int(11) NOT NULL COMMENT '',
...
CREATE TABLE `oc_customer_ip` (
  `customer_ip_id` int(11) NOT NULL COMMENT '',
  `customer_id` int(11) NOT NULL COMMENT '',
  `ip` varchar(40) NOT NULL COMMENT '',
  `date_added` datetime NOT NULL COMMENT '' 
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT '' ;
...
CREATE TABLE `oc_customer_login` (
  `customer_login_id` int(11) NOT NULL COMMENT '',
  `email` varchar(96) NOT NULL COMMENT '',
  `ip` varchar(40) NOT NULL COMMENT '',
  `total` int(4) NOT NULL COMMENT '',
  `date_added` datetime NOT NULL COMMENT '',
...
CREATE TABLE `oc_customer_reward` (
  `customer_reward_id` int(11) NOT NULL COMMENT '',
...
CREATE TABLE `oc_customer_search` (
  `customer_search_id` int(11) NOT NULL COMMENT '',
  `store_id` int(11) NOT NULL COMMENT '',
  `language_id` int(11) NOT NULL COMMENT '',
  `customer_id` int(11) NOT NULL COMMENT '',
  `keyword` varchar(255) NOT NULL COMMENT '',
  `category_id` int(11) DEFAULT NULL COMMENT '',
  `sub_category` tinyint(1) NOT NULL COMMENT '',
  `description` tinyint(1) NOT NULL COMMENT '',
  `products` int(11) NOT NULL COMMENT '',
  `ip` varchar(40) NOT NULL COMMENT '',
  `date_added` datetime NOT NULL COMMENT '' 
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT '' ;
...
CREATE TABLE `oc_customer_transaction` (
  `customer_transaction_id` int(11) NOT NULL COMMENT '',
  `customer_id` int(11) NOT NULL COMMENT '',
  `order_id` int(11) NOT NULL COMMENT '',
  `description` text NOT NULL COMMENT '',
  `amount` decimal(15,4) NOT NULL COMMENT '',
...
CREATE TABLE `oc_custom_field` (
  `custom_field_id` int(11) NOT NULL COMMENT '',
  `type` varchar(32) NOT NULL COMMENT '',
  `value` text NOT NULL COMMENT '',
  `validation` varchar(255) NOT NULL COMMENT '',
  `location` varchar(7) NOT NULL COMMENT '',
  `status` tinyint(1) NOT NULL COMMENT '',
  `sort_order` int(3) NOT NULL COMMENT '' 
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT '' ;
...
CREATE TABLE `oc_custom_field_value` (
  `custom_field_value_id` int(11) NOT NULL COMMENT '',
  `custom_field_id` int(11) NOT NULL COMMENT '',
  `sort_order` int(3) NOT NULL COMMENT '' 
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT '' ;
...
CREATE TABLE `oc_download` (
  `download_id` int(11) NOT NULL COMMENT '主鍵(自增)',
  `filename` varchar(160) NOT NULL COMMENT '上傳到download文件夾下面的文件名）',
  `mask` varchar(128) NOT NULL COMMENT '本地上傳的文件名',
  `date_added` datetime NOT NULL COMMENT '上傳時間' 
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT '下載功能表:存儲商店下載類產品的信息#主鍵：download_id' ;
...
CREATE TABLE `oc_download_description` (
  `download_id` int(11) NOT NULL COMMENT '主鍵（關聯download主鍵)',
  `language_id` int(11) NOT NULL COMMENT '主鍵（關聯language主鍵）',
  `name` varchar(64) NOT NULL COMMENT '該下載類名稱' 
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT '下載信息描述' ;
...
CREATE TABLE `oc_event` (
  `event_id` int(11) NOT NULL COMMENT '主鍵（自增)',
  `code` varchar(32) NOT NULL COMMENT '',
  `trigger` text NOT NULL COMMENT '',
  `action` text NOT NULL COMMENT '',
  `status` tinyint(1) NOT NULL COMMENT '',
  `date_added` datetime NOT NULL COMMENT '' 
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT  '';
...
CREATE TABLE `oc_extension` (
  `extension_id` int(11) NOT NULL COMMENT '主鍵（自增)',
  `type` varchar(32) NOT NULL COMMENT '',
  `code` varchar(32) NOT NULL COMMENT '' 
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT '模塊擴展管理表:存儲管理後台安裝的一些擴展模塊的信息#如添加或者卸載，支付方式、運送方式，增加或#者去掉商店前台的一個展示模塊。' ;
...
CREATE TABLE `oc_filter` (
  `filter_id` int(11) NOT NULL COMMENT '',
  `filter_group_id` int(11) NOT NULL COMMENT '',
  `sort_order` int(3) NOT NULL COMMENT '' 
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT '' ;
...
CREATE TABLE `oc_geo_zone` (
  `geo_zone_id` int(11) NOT NULL COMMENT '',
  `name` varchar(32) NOT NULL COMMENT '',
...
CREATE TABLE `oc_information` (
  `information_id` int(11) NOT NULL COMMENT '主鍵（自增)',
  `bottom` int(1) NOT NULL DEFAULT '0' COMMENT '',
  `sort_order` int(3) NOT NULL DEFAULT '0' COMMENT '排序位置',
  `status` tinyint(1) NOT NULL DEFAULT '1' COMMENT '狀態'
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT '商店附加資訊表:主要存儲一些新聞公告，服務條款等信息內容。#主鍵：information_id' ;
...
CREATE TABLE `oc_information_description` (
  `information_id` int(11) NOT NULL COMMENT '主鍵(關聯 information主鍵)',
  `language_id` int(11) NOT NULL COMMENT '主鍵（關聯 language 主鍵）',
  `title` varchar(64) NOT NULL COMMENT '標題',
  `description` text NOT NULL COMMENT '描述內容',
  `meta_title` varchar(255) NOT NULL COMMENT '',
  `meta_description` varchar(255) NOT NULL COMMENT '',
  `meta_keyword` varchar(255) NOT NULL COMMENT '' 
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT '商店附加資訊描述表#關聯information主鍵: information_id，language_id' ;
...
CREATE TABLE `oc_information_to_store` (
  `information_id` int(11) NOT NULL COMMENT '主鍵(關聯 information主鍵)',
  `store_id` int(11) NOT NULL COMMENT '主鍵（關聯 store 主鍵）' 
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT '關聯商店表：主要存儲不同商店中的information信息。主鍵：information_id，store_id' ;
...
CREATE TABLE `oc_language` (
  `language_id` int(11) NOT NULL COMMENT '主鍵(自增)',
  `name` varchar(32) NOT NULL COMMENT '語言包名稱',
  `code` varchar(5) NOT NULL COMMENT '語言包代碼(eg:英文語言包：en)',
  `locale` varchar(255) NOT NULL COMMENT '語言包字符集編碼',
  `image` varchar(64) NOT NULL COMMENT '語言包前台商店顯示的對應圖片',
  `directory` varchar(32) NOT NULL COMMENT '語言包的文件夾名稱',
  `sort_order` int(3) NOT NULL DEFAULT '0' COMMENT '顯示的位置循序',
  `status` tinyint(1) NOT NULL COMMENT '狀態' 
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT '語言包表：記錄添加的語言包信息。#主鍵:language_id.' ;
...
CREATE TABLE `oc_layout_route` (
  ...
  `layout_id` int(11) NOT NULL COMMENT '',
  `store_id` int(11) NOT NULL COMMENT '',
  `route` varchar(64) NOT NULL COMMENT '' 
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT '' ;
...
CREATE TABLE `oc_length_class` (
  `length_class_id` int(11) NOT NULL COMMENT '主鍵(自增)',
  `value` decimal(15,8) NOT NULL COMMENT '1厘米轉換成該單位的值' 
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT '長度單位表#主鍵：length_class_id' ;
...
CREATE TABLE `oc_length_class_description` (
  `length_class_id` int(11) NOT NULL COMMENT '主鍵(關聯 length_class 主鍵)',
  `language_id` int(11) NOT NULL COMMENT '主鍵(關聯 language 主鍵)',
  `title` varchar(32) NOT NULL COMMENT '長度標題',
  `unit` varchar(4) NOT NULL COMMENT '長度單位英文簡寫' 
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT '長度單位信息表#主鍵; length_class_id.language_id;' ;
...
CREATE TABLE `oc_location` (
  ...
  `telephone` varchar(32) NOT NULL COMMENT '',
  `fax` varchar(32) NOT NULL COMMENT '',
  `geocode` varchar(32) NOT NULL COMMENT '',
  `image` varchar(255) DEFAULT NULL COMMENT '',
  `open` text NOT NULL COMMENT '',
  `comment` text NOT NULL COMMENT '' 
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT '' ;
...
CREATE TABLE `oc_manufacturer` (
  `manufacturer_id` int(11) NOT NULL COMMENT '主鍵(自增)',
  `name` varchar(64) NOT NULL COMMENT '名稱',
  `image` varchar(255) DEFAULT NULL COMMENT '圖片路徑名稱',
  `sort_order` int(3) NOT NULL COMMENT '排序位置' 
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT '品牌或者製造商信息表#主鍵: manufacturer_id' ;
...
CREATE TABLE `oc_manufacturer_to_store` (
  `manufacturer_id` int(11) NOT NULL COMMENT '主鍵(關聯Manufacture主鍵)',
  `store_id` int(11) NOT NULL COMMENT '主鍵(關聯store主鍵)' 
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT '關聯商店表#主鍵: Manufacturer_id, store_id' ;
...
CREATE TABLE `oc_marketing` (
  `marketing_id` int(11) NOT NULL COMMENT '',
  `name` varchar(32) NOT NULL COMMENT '',
  `description` text NOT NULL COMMENT '',
  `code` varchar(64) NOT NULL COMMENT '',
  `clicks` int(5) NOT NULL DEFAULT '0' COMMENT '',
  `date_added` datetime NOT NULL COMMENT '' 
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT '' ;
...
CREATE TABLE `oc_menu_module` (
  `menu_module_id` int(11) NOT NULL COMMENT '',
  `menu_id` int(11) NOT NULL COMMENT '',
  `code` varchar(64) NOT NULL COMMENT '',
  `sort_order` int(3) NOT NULL COMMENT '' 
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT '' ;
...
CREATE TABLE `oc_modification` (
  `modification_id` int(11) NOT NULL COMMENT '',
  `name` varchar(64) NOT NULL COMMENT '',
  `code` varchar(64) NOT NULL COMMENT '',
  `author` varchar(64) NOT NULL COMMENT '',
  `version` varchar(32) NOT NULL COMMENT '',
  `link` varchar(255) NOT NULL COMMENT '',
  `xml` mediumtext NOT NULL COMMENT '',
  `status` tinyint(1) NOT NULL COMMENT '',
  `date_added` datetime NOT NULL COMMENT '' 
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT '' ;
...
CREATE TABLE `oc_option` (
  `option_id` int(11) NOT NULL COMMENT '',
  `type` varchar(32) NOT NULL COMMENT '',
  `sort_order` int(3) NOT NULL COMMENT '' 
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT '' ;
...
CREATE TABLE `oc_option_value` (
  `option_value_id` int(11) NOT NULL COMMENT '',
  `option_id` int(11) NOT NULL COMMENT '',
  `image` varchar(255) NOT NULL COMMENT '',
  `sort_order` int(3) NOT NULL COMMENT '' 
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT '' ;
...
CREATE TABLE `oc_order` (
  `order_id` int(11) NOT NULL COMMENT '主鍵(自增)',
  `invoice_no` int(11) NOT NULL DEFAULT '0' COMMENT '發票編號',
  `invoice_prefix` varchar(26) NOT NULL COMMENT '發票前綴',
  `store_id` int(11) NOT NULL DEFAULT '0' COMMENT '商店編號(關聯store主鍵)',
  `store_name` varchar(64) NOT NULL COMMENT '商店名稱',
  `store_url` varchar(255) NOT NULL COMMENT '商店的web路徑',
  `customer_id` int(11) NOT NULL DEFAULT '0' COMMENT '客戶編號（遊客購買默認為零）',
  `customer_group_id` int(11) NOT NULL DEFAULT '0' COMMENT '客戶組編號',
  `firstname` varchar(32) NOT NULL COMMENT '姓',
  `lastname` varchar(32) NOT NULL COMMENT '名',
  `email` varchar(96) NOT NULL COMMENT '電子信箱',
  `telephone` varchar(32) NOT NULL COMMENT '',
  `fax` varchar(32) NOT NULL COMMENT '電話',
  `custom_field` text NOT NULL COMMENT '傳真',
  `payment_firstname` varchar(32) NOT NULL COMMENT '買家姓',
  `payment_lastname` varchar(32) NOT NULL COMMENT '買家名',
  `payment_company` varchar(60) NOT NULL COMMENT '買家公司名稱',
  `payment_address_1` varchar(128) NOT NULL COMMENT '買家街道地址',
  `payment_address_2` varchar(128) NOT NULL COMMENT '',
  `payment_city` varchar(128) NOT NULL COMMENT '買家所在城市',
  `payment_postcode` varchar(10) NOT NULL COMMENT '買家所在地郵編',
  `payment_country` varchar(128) NOT NULL COMMENT '買家所在國家',
  `payment_country_id` int(11) NOT NULL COMMENT '買家所在國家編號（關聯country主鍵）',
  `payment_zone` varchar(128) NOT NULL COMMENT '買家所在地區',
  `payment_zone_id` int(11) NOT NULL COMMENT '買家所在地區編號（關聯zone主鍵）',
  `payment_address_format` text NOT NULL COMMENT '',
  `payment_custom_field` text NOT NULL COMMENT '',
  `payment_method` varchar(128) NOT NULL COMMENT '支付方式',
  `payment_code` varchar(128) NOT NULL COMMENT '',
  `shipping_firstname` varchar(32) NOT NULL COMMENT '',
  `shipping_lastname` varchar(32) NOT NULL COMMENT '',
  `shipping_company` varchar(40) NOT NULL COMMENT '',
  `shipping_address_1` varchar(128) NOT NULL COMMENT '',
  `shipping_address_2` varchar(128) NOT NULL COMMENT '',
  `shipping_city` varchar(128) NOT NULL COMMENT '',
  `shipping_postcode` varchar(10) NOT NULL COMMENT '',
  `shipping_country` varchar(128) NOT NULL COMMENT '',
  `shipping_country_id` int(11) NOT NULL COMMENT '',
  `shipping_zone` varchar(128) NOT NULL COMMENT '',
  `shipping_zone_id` int(11) NOT NULL COMMENT '',
  `shipping_address_format` text NOT NULL COMMENT '',
  `shipping_custom_field` text NOT NULL COMMENT '',
  `shipping_method` varchar(128) NOT NULL COMMENT '',
  `shipping_code` varchar(128) NOT NULL COMMENT '',
  `comment` text NOT NULL COMMENT '訂單附加信息',
  `total` decimal(15,4) NOT NULL DEFAULT '0.0000' COMMENT '訂單總金額',
  `order_status_id` int(11) NOT NULL DEFAULT '0' COMMENT '訂單狀態（關聯order_status主鍵）',
  `affiliate_id` int(11) NOT NULL COMMENT '',
  `commission` decimal(15,4) NOT NULL COMMENT '',
  `marketing_id` int(11) NOT NULL COMMENT '',
  `tracking` varchar(64) NOT NULL COMMENT '',
  `language_id` int(11) NOT NULL COMMENT '語言包編號',
  `currency_id` int(11) NOT NULL COMMENT '',
  `currency_code` varchar(3) NOT NULL COMMENT '',
  `currency_value` decimal(15,8) NOT NULL DEFAULT '1.00000000',
  `ip` varchar(40) NOT NULL COMMENT '買家IP地址',
  `forwarded_ip` varchar(40) NOT NULL COMMENT '',
  `user_agent` varchar(255) NOT NULL COMMENT '',
  `accept_language` varchar(255) NOT NULL COMMENT '',
  `date_added` datetime NOT NULL COMMENT '訂單修改日期',
  `date_modified` datetime NOT NULL COMMENT '訂單添加日期' 
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT '訂單表:記錄訂單信息，買家信息。#主鍵:order_id' ;
...
CREATE TABLE `oc_order_custom_field` (
  `order_custom_field_id` int(11) NOT NULL COMMENT '',
  `order_id` int(11) NOT NULL COMMENT '',
  `custom_field_id` int(11) NOT NULL COMMENT '',
  `custom_field_value_id` int(11) NOT NULL COMMENT '',
  ...
  `value` text NOT NULL COMMENT '',
  `type` varchar(32) NOT NULL COMMENT '',
  `location` varchar(16) NOT NULL COMMENT '' 
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT '' ;
...
CREATE TABLE `oc_order_option` (
  `order_option_id` int(11) NOT NULL COMMENT '',
  `order_id` int(11) NOT NULL COMMENT '',
  `order_product_id` int(11) NOT NULL COMMENT '',
  `product_option_id` int(11) NOT NULL COMMENT '',
  `product_option_value_id` int(11) NOT NULL DEFAULT '0' COMMENT '',
  `name` varchar(255) NOT NULL COMMENT '',
  `value` text NOT NULL COMMENT '',
  `type` varchar(32) NOT NULL COMMENT '' 
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT '' ;
...
CREATE TABLE `oc_order_recurring` (
  `order_recurring_id` int(11) NOT NULL COMMENT '',
  `order_id` int(11) NOT NULL COMMENT '',
  `reference` varchar(255) NOT NULL COMMENT '',
  `product_id` int(11) NOT NULL COMMENT '',
  `product_name` varchar(255) NOT NULL COMMENT '',
  `product_quantity` int(11) NOT NULL COMMENT '',
  `recurring_id` int(11) NOT NULL COMMENT '',
  `recurring_name` varchar(255) NOT NULL COMMENT '',
  `recurring_description` varchar(255) NOT NULL COMMENT '',
  `recurring_frequency` varchar(25) NOT NULL COMMENT '',
  `recurring_cycle` smallint(6) NOT NULL COMMENT '',
  `recurring_duration` smallint(6) NOT NULL COMMENT '',
  `recurring_price` decimal(10,4) NOT NULL COMMENT '',
  `trial` tinyint(1) NOT NULL COMMENT '',
  `trial_frequency` varchar(25) NOT NULL COMMENT '',
  `trial_cycle` smallint(6) NOT NULL COMMENT '',
  `trial_duration` smallint(6) NOT NULL COMMENT '',
  `trial_price` decimal(10,4) NOT NULL COMMENT '',
...
CREATE TABLE `oc_order_recurring_transaction` (
  `order_recurring_transaction_id` int(11) NOT NULL COMMENT '',
  `order_recurring_id` int(11) NOT NULL COMMENT '',
  `reference` varchar(255) NOT NULL COMMENT '',
...
CREATE TABLE `oc_order_voucher` (
  `order_voucher_id` int(11) NOT NULL COMMENT '',
  `order_id` int(11) NOT NULL COMMENT '',
  `voucher_id` int(11) NOT NULL COMMENT '',
  `description` varchar(255) NOT NULL COMMENT '',
  `code` varchar(10) NOT NULL COMMENT '',
  `from_name` varchar(64) NOT NULL COMMENT '',
  `from_email` varchar(96) NOT NULL COMMENT '',
  `to_name` varchar(64) NOT NULL COMMENT '',
  `to_email` varchar(96) NOT NULL COMMENT '',
  `voucher_theme_id` int(11) NOT NULL COMMENT '',
...
CREATE TABLE `oc_product` (
  `product_id` int(11) NOT NULL COMMENT '主鍵(自增)',
  `model` varchar(64) NOT NULL COMMENT '模型名稱',
  `sku` varchar(64) NOT NULL COMMENT '庫存單元',
  `upc` varchar(12) NOT NULL COMMENT '',
  `ean` varchar(14) NOT NULL COMMENT '',
  `jan` varchar(13) NOT NULL COMMENT '',
  `isbn` varchar(17) NOT NULL COMMENT '',
  `mpn` varchar(64) NOT NULL COMMENT '',
  `location` varchar(128) NOT NULL COMMENT '*******************',
  `quantity` int(4) NOT NULL DEFAULT '0' COMMENT '商品數目',
  `stock_status_id` int(11) NOT NULL COMMENT '庫存狀態編號（關聯stock_status主鍵）',
  `image` varchar(255) DEFAULT NULL COMMENT '產品圖片路徑',
  `manufacturer_id` int(11) NOT NULL COMMENT '製造商編號（關聯manufacturer主鍵）',
  `shipping` tinyint(1) NOT NULL DEFAULT '1' COMMENT '是否需要運送',
  `price` decimal(15,4) NOT NULL DEFAULT '0.0000' COMMENT '價格',
  `points` int(8) NOT NULL DEFAULT '0' COMMENT '',
  `tax_class_id` int(11) NOT NULL COMMENT '稅項編號（關聯tax主鍵）',
  `date_available` date NOT NULL DEFAULT '0000-00-00' COMMENT '商品有效日期',
  `weight` decimal(15,8) NOT NULL DEFAULT '0.00000000' COMMENT '重量',
  `weight_class_id` int(11) NOT NULL DEFAULT '0' COMMENT '重量編號（關聯weight_class主鍵）',
  `length` decimal(15,8) NOT NULL DEFAULT '0.00000000' COMMENT '長度',
  `width` decimal(15,8) NOT NULL DEFAULT '0.00000000' COMMENT '寬度',
  `height` decimal(15,8) NOT NULL DEFAULT '0.00000000' COMMENT '高度',
  `length_class_id` int(11) NOT NULL DEFAULT '0' COMMENT '長度編號（關聯length_class主鍵）',
  `subtract` tinyint(1) NOT NULL DEFAULT '1' COMMENT '是否扣除****',
  `minimum` int(11) NOT NULL DEFAULT '1' COMMENT '',
  `sort_order` int(11) NOT NULL DEFAULT '0' COMMENT '排序位置',
  `status` tinyint(1) NOT NULL DEFAULT '0' COMMENT '狀態（0/1）',
  `viewed` int(5) NOT NULL DEFAULT '0' COMMENT '**************',
  `date_added` datetime NOT NULL COMMENT '商品添加日期',
  `date_modified` datetime NOT NULL COMMENT '商品修改信息' 
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT '產品信息主表#主鍵：product_id';
...
CREATE TABLE `oc_product_description` (
  `product_id` int(11) NOT NULL COMMENT '主鍵（關聯product主鍵）',
  `language_id` int(11) NOT NULL COMMENT '語言包（關聯 language主鍵）',
  `name` varchar(255) NOT NULL COMMENT '產品名稱',
  `description` text NOT NULL COMMENT '產品描述',
  `tag` text NOT NULL COMMENT '',
  `meta_title` varchar(255) NOT NULL COMMENT '產品標題',
  `meta_description` varchar(255) NOT NULL COMMENT '產品信息頁關鍵字',
  `meta_keyword` varchar(255) NOT NULL COMMENT '產品信息頁關鍵字' 
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT '產品信息描述表#主鍵: product_id, product_id' ;
...
CREATE TABLE `oc_product_discount` (
  `product_discount_id` int(11) NOT NULL COMMENT '主鍵(自增)',
  `product_id` int(11) NOT NULL COMMENT '商品編號(關聯product主鍵)',
  `customer_group_id` int(11) NOT NULL COMMENT '註冊會員組別編號（關聯customer_group主鍵）',
  `quantity` int(4) NOT NULL DEFAULT '0' COMMENT '打折商品的數目',
  `priority` int(5) NOT NULL DEFAULT '1' COMMENT '打著商品的餓優先級',
  `price` decimal(15,4) NOT NULL DEFAULT '0.0000' COMMENT '打折商品價格',
  `date_start` date NOT NULL DEFAULT '0000-00-00' COMMENT '打折商品上架時間',
  `date_end` date NOT NULL DEFAULT '0000-00-00' COMMENT '打折商品下架時間'
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT '產品信息描述表#主鍵: product_id, product_id' ;

--
-- 資料表的匯出資料 `oc_product_discount`
--
...
CREATE TABLE `oc_product_filter` (
  `product_id` int(11) NOT NULL COMMENT '商品編號',
  `filter_id` int(11) NOT NULL COMMENT '' 
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT '暢銷產品表' ;
...
CREATE TABLE `oc_product_image` (
  `product_image_id` int(11) NOT NULL COMMENT '主鍵（自增）',
  `product_id` int(11) NOT NULL COMMENT '商品編號（關聯product主鍵）',
  `image` varchar(255) DEFAULT NULL COMMENT '圖片路徑',
  `sort_order` int(3) NOT NULL DEFAULT '0' COMMENT '排序'
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT '商品圖片表：記錄一個商品的不同圖片路徑。' ;
...
CREATE TABLE `oc_product_option` (
  `product_option_id` int(11) NOT NULL COMMENT '主鍵（自增）',
  `product_id` int(11) NOT NULL COMMENT '商品編號（關聯product主鍵）',
  `option_id` int(11) NOT NULL COMMENT '',                                                                                                                                              
  `value` text NOT NULL COMMENT '',
  `required` tinyint(1) NOT NULL COMMENT '' 
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT '商品額外選項表:記錄一種商品的不同配置信息#主鍵：product_option_id' ;

--
-- 資料表的匯出資料 `oc_product_option`
--
...
CREATE TABLE `oc_product_option_value` (
  `product_option_value_id` int(11) NOT NULL COMMENT '主鍵（自增）',
  `product_option_id` int(11) NOT NULL COMMENT '商品附加選項編號（關聯product_option主鍵）',
  `product_id` int(11) NOT NULL COMMENT '商品編號',
  `option_id` int(11) NOT NULL COMMENT '',
  `option_value_id` int(11) NOT NULL COMMENT '',
  `quantity` int(3) NOT NULL COMMENT '該附加選項數目',
  `subtract` tinyint(1) NOT NULL COMMENT '**********',
  `price` decimal(15,4) NOT NULL COMMENT '附加選項單價',
  `price_prefix` varchar(1) NOT NULL COMMENT '前綴',
  `points` int(8) NOT NULL COMMENT '',
  `points_prefix` varchar(1) NOT NULL COMMENT '',
  `weight` decimal(15,8) NOT NULL COMMENT '',
  `weight_prefix` varchar(1) NOT NULL COMMENT '' 
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT '商品附加選項金額表#主鍵：product_option_value_id' ;

--
-- 資料表的匯出資料 `oc_product_option_value`
--
...
CREATE TABLE `oc_product_related` (
  `product_id` int(11) NOT NULL COMMENT '商品編號（關聯Producte主鍵）',
  `related_id` int(11) NOT NULL COMMENT '商品編號（關聯Producte主鍵' 
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT '商品之間的關聯表:主鍵：product_id，related_id' ;
--
...
CREATE TABLE `oc_product_reward` (
  `product_reward_id` int(11) NOT NULL COMMENT '',
...
CREATE TABLE `oc_product_special` (
  `product_special_id` int(11) NOT NULL COMMENT '主鍵（自增/自增量1）',
  `product_id` int(11) NOT NULL COMMENT '商品編號（關聯Producte主鍵）',
  `customer_group_id` int(11) NOT NULL COMMENT '註冊會員組別編號(關聯customer_group主鍵)',
  `priority` int(5) NOT NULL DEFAULT '1' COMMENT '優先級',
  `price` decimal(15,4) NOT NULL DEFAULT '0.0000' COMMENT '商品單價',
  `date_start` date NOT NULL DEFAULT '0000-00-00' COMMENT '',
  `date_end` date NOT NULL DEFAULT '0000-00-00' COMMENT ''
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT '特賣商品表：記錄商店的特賣商品的信息#主鍵:product_special_id' ;

--
-- 資料表的匯出資料 `oc_product_special`
--
...
CREATE TABLE `oc_product_to_download` (
  `product_id` int(11) NOT NULL COMMENT '',
  `download_id` int(11) NOT NULL COMMENT '' 
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT '' ;
...
CREATE TABLE `oc_recurring` (
  ...
  `frequency` enum('day','week','semi_month','month','year') NOT NULL COMMENT '',
  `duration` int(10) UNSIGNED NOT NULL COMMENT '',
  `cycle` int(10) UNSIGNED NOT NULL COMMENT '',
  `trial_status` tinyint(4) NOT NULL COMMENT '',
  `trial_price` decimal(10,4) NOT NULL COMMENT '',
  `trial_frequency` enum('day','week','semi_month','month','year') NOT NULL COMMENT '',
  `trial_duration` int(10) UNSIGNED NOT NULL COMMENT '',
  `trial_cycle` int(10) UNSIGNED NOT NULL COMMENT '',
  `status` tinyint(4) NOT NULL COMMENT '',
...
CREATE TABLE `oc_return` (
  ...
  `email` varchar(96) NOT NULL COMMENT '',
  `telephone` varchar(32) NOT NULL COMMENT '',
  `product` varchar(255) NOT NULL COMMENT '',
  `model` varchar(64) NOT NULL COMMENT '',
  `quantity` int(4) NOT NULL COMMENT '',
  ...
  `comment` text,
  `date_ordered` date NOT NULL DEFAULT '0000-00-00' COMMENT '',
  `date_added` datetime NOT NULL COMMENT '',
  `date_modified` datetime NOT NULL COMMENT '' 
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT '' ;
...
CREATE TABLE `oc_return_history` (
  `return_history_id` int(11) NOT NULL COMMENT '',
  `return_id` int(11) NOT NULL COMMENT '',
  `return_status_id` int(11) NOT NULL COMMENT '',
  `notify` tinyint(1) NOT NULL COMMENT '',
  `comment` text NOT NULL COMMENT '',
  `date_added` datetime NOT NULL COMMENT '' 
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT '' ;
...
CREATE TABLE `oc_setting` (
  `setting_id` int(11) NOT NULL COMMENT '',
  `store_id` int(11) NOT NULL DEFAULT '0' COMMENT '',
  `code` varchar(32) NOT NULL COMMENT '',
  `key` varchar(64) NOT NULL COMMENT '',
  `value` text NOT NULL COMMENT '',
  `serialized` tinyint(1) NOT NULL COMMENT '' 
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT '' ;
...
(21, 0, 'config', 'config_language', 'zh-TW', 0),
(22, 0, 'config', 'config_admin_language', 'zh-TW', 0),
(23, 0, 'config', 'config_currency', 'TWD', 0),
...
(174, 0, 'config', 'config_email', 'suffixbig@gmail.com', 0),
...
(175, 0, 'config', 'config_encryption', '', 0),
...
CREATE TABLE `oc_store` (
  ...
  `ssl` varchar(255) NOT NULL COMMENT '' 
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT '' ;
...
CREATE TABLE `oc_tax_rate` (
  ...
  `geo_zone_id` int(11) NOT NULL DEFAULT '0' COMMENT '',
  `name` varchar(32) NOT NULL COMMENT '',
...
CREATE TABLE `oc_tax_rule` (
  `tax_rule_id` int(11) NOT NULL COMMENT '',
  `tax_class_id` int(11) NOT NULL COMMENT '',
  `tax_rate_id` int(11) NOT NULL COMMENT '',
  `based` varchar(10) NOT NULL COMMENT '',
...
CREATE TABLE `oc_theme` (
  `theme_id` int(11) NOT NULL COMMENT '',
  `store_id` int(11) NOT NULL COMMENT '',
  `theme` varchar(64) NOT NULL COMMENT '',
  `route` varchar(64) NOT NULL COMMENT '',
...
CREATE TABLE `oc_translation` (
  `translation_id` int(11) NOT NULL COMMENT '',
  `store_id` int(11) NOT NULL COMMENT '',
  `language_id` int(11) NOT NULL COMMENT '',
  `route` varchar(64) NOT NULL COMMENT '',
  `key` varchar(64) NOT NULL COMMENT '',
...
CREATE TABLE `oc_upload` (
  `upload_id` int(11) NOT NULL COMMENT '',
  `name` varchar(255) NOT NULL COMMENT '',
...
CREATE TABLE `oc_url_alias` (
  `url_alias_id` int(11) NOT NULL COMMENT '',
  `query` varchar(255) NOT NULL COMMENT '',
  `keyword` varchar(255) NOT NULL COMMENT '' 
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT '' ;
...
(1, 1, 'admin', '36d77595431036541bd2ada36fe3637595a23e3f', 'YtJ2yFZGM', 'John', 'Doe', 'suffixbig@gmail.com', '', '', '127.0.0.1', 1, '2017-04-21 16:38:02');
...
CREATE TABLE `oc_user_group` (
  `user_group_id` int(11) NOT NULL COMMENT '',
  `name` varchar(64) NOT NULL COMMENT '',
  `permission` text NOT NULL COMMENT '' 
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT '' ;
...
CREATE TABLE `oc_voucher_history` (
  `voucher_history_id` int(11) NOT NULL COMMENT '',
  `voucher_id` int(11) NOT NULL COMMENT '',
  `order_id` int(11) NOT NULL COMMENT '',
  `amount` decimal(15,4) NOT NULL COMMENT '',
  `date_added` datetime NOT NULL COMMENT '' 
...
CREATE TABLE `oc_weight_class` (
  `weight_class_id` int(11) NOT NULL COMMENT '',
  `value` decimal(15,8) NOT NULL DEFAULT '0.00000000' COMMENT ''
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT '' ;
...
CREATE TABLE `oc_weight_class_description` (
  ...
  `language_id` int(11) NOT NULL COMMENT '',
  `title` varchar(32) NOT NULL COMMENT '',
  `unit` varchar(4) NOT NULL COMMENT '' 
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT '' ;
...
CREATE TABLE `oc_zone_to_geo_zone` (
  `zone_to_geo_zone_id` int(11) NOT NULL COMMENT '',
  `country_id` int(11) NOT NULL COMMENT '',
