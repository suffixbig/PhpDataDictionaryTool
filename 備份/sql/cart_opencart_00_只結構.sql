...
Source Server         : localhost_azsx1277
Source Server Version : 50714
Source Host           : localhost:3306
Source Database       : cart_opencart_00

Target Server Type    : MYSQL
Target Server Version : 50714
File Encoding         : 65001

Date: 2017-04-24 16:36:25
*/
...
) ENGINE=MyISAM AUTO_INCREMENT=59 DEFAULT CHARSET=utf8 COMMENT='產品分類表：用於商品的多級分類#主鍵：category_id';
...
) ENGINE=MyISAM AUTO_INCREMENT=50 DEFAULT CHARSET=utf8 COMMENT='產品信息主表#主鍵：product_id';
...
) ENGINE=MyISAM AUTO_INCREMENT=441 DEFAULT CHARSET=utf8 COMMENT='產品信息描述表#主鍵: product_id, product_id';
...
CREATE TABLE `oc_product_image` (
  ...
  KEY `product_id` (`product_id`)
) ENGINE=MyISAM AUTO_INCREMENT=2352 DEFAULT CHARSET=utf8 COMMENT='商品圖片表：記錄一個商品的不同圖片路徑。';
